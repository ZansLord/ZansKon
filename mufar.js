...
const daftar2 = '*Created © ZANS BOTZ*'
const daftar3 = [{buttonId: `verify`,buttonText: {displayText: `Daftar Mamank`,},type: 1,},]
...
// Wadefak Men
const fmen = { key : { participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 2021, status: 1, surface : 1, message: `© Zans Botz Official`, thumbnail: fs.readFileSync('./src/Mufar.jpg'), sellerJid: '0@s.whatsapp.net'}}}
const fdoc = { key: { participant : '0@s.whatsapp.net'}, message: {documentMessage: {title: `© ZansBotz`, jpegThumbnail: thumb}}}
...
const fgif = { key: { participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: {"videoMessage": { "title":`© ZansBotz`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `© ZansBotz`, 'jpegThumbnail': thumb}}}
const fgclink = { key: { participant: '0@s.whatsapp.net', "remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6283871990243-1616169743@g.us","inviteCode": "m","groupName": "Xrutz Official", "caption": `© ZansBotz`, 'jpegThumbnail': thumb}}}
const fvideo = { key: { fromMe: false, participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: { "videoMessage": { "title":`© Zans Botz Official`, "h": `Hmm`,'seconds': '99999', 'caption': `© ZansBotz`, 'jpegThumbnail': thumb}}}
const floc = { key: { participant : '0@s.whatsapp.net'}, message: {locationMessage: {name: `© ZansBotz`, jpegThumbnail: thumbz}}}
const fakevo = { key: { fromMe: false, participant: '0@s.whatsapp.net', remoteJid: 'status@broadcast'}, message: {imageMessage: {mimetype: 'image/jpeg', caption: 'ZansGanz Selfbot', jpegThumbnail: fs.readFileSync('./src/Mufar.jpg'), viewOnce: true}}}
...
{ buttonId: `${prefix}owner`, buttonText: { displayText: 'Creator ZansBotz' }, type: 1 }
]
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
nama ='𝙋𝙄𝙋𝙄 𝘽𝙊𝙏𝙕4𝙔𝙊𝙐'
ownerJid = "6289643314604@s.whatsapp.net"
...
gbutsan = [
{buttonId:`owner`, buttonText:{displayText: 'Creator Zansbot'}, type:1},
...
footerText: '*_© Zans - Official Bot_*',
description: `${tampilUcapan} ${pushname}, *Hallo User @${sender.split('@')[0]}, Silahkan pilih menu Zans-Bot disini*`,
sections: [
                 {
                 "title": `${week}, ${calender}`,
 rows: [
...
case 'rulesbot':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
ruls =`*Syarat & Ketentuan ZansBot.ೃ🐣*
...
*Silahkan lanjut gunakan Zans Bot!*`
...
members_ids.push(mem.jid)
            ...
            + 'END:VCARD'.trim()
            Mufar.sendMessage(from, {displayName: `Name YT : Zans Bot`, vcard: vcard2}, contact, 
            { quoted: fmen, 
            })
            replyWithFakeLink('*Ini Nomor Owner Zans BOT*\nMau Chat? Utamakan Salam!')
            limitAdd(sender, limit)
            break
...
trans = `Created © Zans Botz Official`
but = [
...
const btnsharam = {
contentText: `${mek}`,
footerText: '*_© Zans Botz Official_*',
buttons: buttons,
headerType: 1
}
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
if (isLimit(sender, isPrem, isOwner, limitawal, limit)) return reply(mess.limit)
if (args.length == 0) return reply(`Example: ${prefix + command} Zans Botz Official`)
mf4r = args.join(" ")
buffer = await getBuffer(`https://api.lolhuman.xyz/api/tweettrump?apikey=${lolkey}&text=${mf4r}`)
Mufar.sendMessage(from, buffer, image, {quoted: mek, caption: '*© Zans Botz Official*'})
limitAdd(sender, limit)
break
...
Mufar.sendMessage(from, buffer, image, {quoted: mek, caption: '*© Zans Official*'})
break
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
if (isLimit(sender, isPrem, isOwner, limitawal, limit)) return reply(mess.limit)
if (args.length == 0) return reply(`Example: ${prefix + command} Zans`)
txt1 = args[0]
txt2 = args[1]
